const dynamicCache = 'site-dynamic-v103'
const dynamicCache_MAXSIZE = 511;
const staticCache = 'site-static-v29' //Increment whenever a change is made to one of the following assets
const assets = [
    '/',
    '/index.html',
    '/js/app.js',
